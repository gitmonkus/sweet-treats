"""
Django settings for Sweet_treat project.
...
SECRET_KEY = 'django-insecure-c=7t5obi7_h7#)n__ukbv5y0x+hq=_j@cna8^-%9t9cb$&d&hr'
...
WSGI_APPLICATION = 'Sweet_treat.wsgi.application'
